...
# This project was completed in one of my public health classes. The data set was 
# provided by the instructor and was cleaned in Excel.The data set contains information on the
...
Prostate <- read.xlsx("C:/Users/meganak/Desktop/Prostate.xlsx", sheet=1, colNames=TRUE)
